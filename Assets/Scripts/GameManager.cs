...
public class GameManager : MonoBehaviour
{
    ...
    // Death Scene Configuration
    [SerializeField] private string deathSceneName = "DeathScene"; // Nombre configurable de la escena de muerte
    ...
    public IEnumerator DeathCoroutine()
    {
        ...
        if (isGameOver)
        {
            // Load the specified death scene
